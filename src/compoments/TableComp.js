...
const rows = [
  createData('Shoulder reconstruction', 'january 2008',  'General Breathing Tube', 'No','No'),
];
      ...
      <Table sx={{ minWidth: 150 }}  aria-label="simple table">
        <TableHead >
          <TableRow className={classes.title}>
            ...
            <TableCell align="">Anethesisa Complication (nausea,vomiting,difficult intubation)</TableCell>
          </TableRow>
        </TableHead>
        <TableBody className={classes.body}>
          {rows.map((row) => (
